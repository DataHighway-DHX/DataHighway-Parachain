...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn submit_fetched_mpower_unsigned(
            ...
            Self::add_mpower(start_of_requested_date_millis.clone(), mpower_payload_vec.clone());
        ...
        pub fn submit_finished_fetching_mpower_unsigned(
            ...
            Self::add_finished_fetching_mpower(fetched_mpower_data.clone());
            // now increment the block number at which we expect next unsigned transaction
    ...
    impl<T: Config> ValidateUnsigned for Pallet<T> {
        ...
        fn validate_unsigned(_source: TransactionSource, call: &Self::Call) -> TransactionValidity {
            if let Call::submit_fetched_mpower_unsigned { block_number, start_of_requested_date_millis, mpower_payload_vec } = call {
                log::info!("validate_unsigned submit_fetched_mpower_unsigned");
                return Self::validate_transaction_parameters_for_fetched_mpower(block_number, start_of_requested_date_millis, mpower_payload_vec);
    ...
    impl<T: Config> Pallet<T> {
        ...
        fn store_mpower_raw_unsigned(block_number: T::BlockNumber, start_of_requested_date_millis: Date, mpower_payload_vec: Vec<MPowerPayloadData<T>>) -> Result<(), &'static str> {
            ...
            // passing `mpower_payload_vec` as an argument.
            let call = Call::submit_fetched_mpower_unsigned { block_number, start_of_requested_date_millis, mpower_payload_vec };
        ...
        fn store_finished_fetching_mpower_raw_unsigned(block_number: T::BlockNumber, fetched_mpower_data: FetchedMPowerForAccountsForDatePayloadData) -> Result<(), &'static str> {
            ...
            let call = Call::submit_finished_fetching_mpower_unsigned { block_number, fetched_mpower_data };
        ...
        fn add_mpower(start_of_requested_date_millis: Date, mpower_data_vec: Vec<MPowerPayloadData<T>>) -> Option<Vec<MPowerPayloadData<T>>> {
        ...
        fn add_finished_fetching_mpower(fetched_mpower_data: FetchedMPowerForAccountsForDatePayloadData) -> Option<FetchedMPowerForAccountsForDatePayloadData> {
            // note: AccountId as Vec<u8> is [0, 0, ... 0] since its an unsigned transaction
